@echo off
:: Generated on 2025-07-13 01:03:45 GMT
...
:START_PROCESS
title 26200.5670_amd64_en-us_professional_adf22284 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=adf22284-b67d-4ffe-b3c3-cc0209447019&pack=en-us&edition=professional&aria2=2"
if %ERRORLEVEL% GTR 0 call :DOWNLOAD_ERROR & exit /b 1
echo.
