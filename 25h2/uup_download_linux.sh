...
aria2c --no-conf --console-log-level=warn --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=adf22284-b67d-4ffe-b3c3-cc0209447019&pack=en-us&edition=professional&aria2=2"
if [ $? != 0 ]; then
